...
\paragraph{Using the Application}
\paragraph{}
...
\begin{framed}
%\begin{verbatim}
{\bf MultiPEN} {\it mcrpath }  {\bf FeatureSelection } {\it Output } {\it Expression } {\it Interactions } {\it Class } {\it lambda } 
...
{\bf MultiPEN}:  This is the nombre of the software, which has to be typed to launch the program.

{\it mcrpath}: 

{\it Output}:  Specify directory to save the output image, default is: {\it output/MultiPEN/stats/} 
